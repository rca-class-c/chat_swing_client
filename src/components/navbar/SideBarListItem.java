...
public class SideBarListItem extends JButton{
    ...
    public SideBarListItem(String imagePath, String name) throws IOException {
       ...
       // label.setSize(50, 35);
        ...
        System.out.println(System.getProperty("user.dir") + "/src/components/navbar/images/" + imagePath);
        BufferedImage myPicture = ImageIO.read(new File(System.getProperty("user.dir") + "/src/components/navbar/images/" + imagePath));
